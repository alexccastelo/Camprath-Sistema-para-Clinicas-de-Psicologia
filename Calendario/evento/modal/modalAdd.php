			...
			<form class="form-horizontal" method="POST" action="evento/action/eventoAdd.php" onsubmit="return validaForm(this);">
			  ...
			  <div class="modal-body">
				  ...
				  <div class="form-group">
					<label for="titulo" class="col-sm-2 control-label">Nome do Paciente</label>
					<div class="col-sm-10">
					  <input type="text" name="titulo" class="form-control" id="titulo" placeholder="Nome Completo" required>
					</div>
				  </div>

				  <div class="form-group">
					<label for="descricao" class="col-sm-2 control-label">Número do Convênio</label>
					<div class="col-sm-10">
					  <input type="text" name="descricao" class="form-control" id="descricao" placeholder="Número do convênio"></input>
					</div>
				  </div>
